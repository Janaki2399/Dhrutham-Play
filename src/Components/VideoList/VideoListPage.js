...
export function VideoListPage({list}){
    ...
    const [videoId,setVideoId]=useState(selectedCategoryObject.list.length>0?selectedCategoryObject.list[0].videoId:"");
    ...
    return(
        ...
        <div className="grid">
            ...
            <main>
           { videoId!=="" && <ViewVideo videoId={videoId} setModal={setModal}/>}
            </main>
            <SideBarNav playlistId={selectedCategoryObject.id}
